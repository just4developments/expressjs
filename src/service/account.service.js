...
exports = module.exports = {
	...
	async login(item = {}) {		
		...
		return `${user.project_id}-${user._id}-${user.token}-${project.plugins.oauth.session_expired}`;
	},
...
<br/>`,
	...
	async updateMore(where, more){
		return await db.manual(exports.COLLECTION, async (collection, db) => {
			return await collection.update(where, more, {multi: true});
		});
	},
